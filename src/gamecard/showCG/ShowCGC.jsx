  ...
  return (
    <>
      <div className='screenSAG'>
        ...
        <div
          className=" text-white rounded-full w-20 h-10 flex items-center justify-center cursor-pointer ml-5 mb-5 bg-[#EFA6CA]"
          onClick={() => navigate('/')}
        >
        ...
        <div className='flex flex-wrap'>
          {categories
            .filter(category => category.name === "Couples")
            .map(category =>
              category.game.map(gameItem => (
                <div
                  key={gameItem.id}
                  className="BoxAG BoxAGC"
